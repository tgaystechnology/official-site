    ...
    const handlePayment = async (e) => {
        ...
        try {
            ...
            const leadData = {
                ...
                phone: phone,
                note: description ? 
                    `${plan?.title || 'Unknown Plan'} (${selectedSubscription || 'Yearly'} Subscription). Description: ${description}` : 
                    `${plan?.title || 'Unknown Plan'} (${selectedSubscription || 'Yearly'} Subscription)`
            };
