      ...
      <div className="container">
        <div className="row">
            ...
            <div className="row">
              <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                <div className="about-img-1">
                  <img src="img/about-5.png" alt="TGays Technology IT Services Experience" loading="lazy" />
                  <Link href="#" className="btn btn-main">10 years in IT Services</Link>
                </div>
              </div>
              <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                <div className="about-img-1 girl_img">
                  <img src="img/about_1.png" alt="Professional IT Solutions Team at TGays Technology"
                loading="lazy" />
                </div>
              </div>
            </div>
          ...
          <div className="col-xl-6 col-lg-6 about-us-sec">
            <div className="crumina-module crumina-heading">
              <div className="about-us-hedding">
                <h2 className="heading-title">
                  <span className="c-primary">About</span> TGays Technology
                </h2>
              </div>
            ...
            <Link href="/about-us/company" className="read-more-link" aria-label="Read more about TGays Technology">
              ...
              <div className="row">
                  ...
                  <div className="tech-about-content-bottom">
                    <div className="tech-about-content-admin">
                      <div className="tech-about-content-admin-img">
                        <img src="img/najish.png" alt="Jamal Ashraf Founder and Director of TGays Technology"
                      loading="lazy" />
                      </div>
                ...
                <div className="col-12 col-md-6 col-lg-6">
                  <div className="tech-about-content-bottom vikash_sec">
                    <div className="tech-about-content-admin">
                      <div className="tech-about-content-admin-img">
                        <img src="img/vikash.png" alt="Vikash Kumar Technical Head and Director at TGays Technology"
                      loading="lazy" />
                      </div>
                      <div className="tech-about-content-admin-info">
