...
const OurApproachProcess = () => {
  return (
    <section className="our-approach-section" role="region" aria-labelledby="our-approach-heading">
      <div className="container pb-70">
        <div className="crumina-module crumina-heading align-center">
          <h2 id="our-approach-heading" className="heading-title">Our Approach & Process</h2>
        </div>
        <div className="ns-custom-inner">
          <div className="ns-custom-content">
            <div className="ns-custom-content-top">
              <h3 className="ns-custom-content-title">Our Collaborative Path to Digital Excellence</h3>
            ...
            <div className="ns-custom-content-bottom">
              <ul>
                <li>
                  <span className="ns-custom-content-bottom-icon" aria-hidden="true">
                    <ion-icon name="checkmark-outline"></ion-icon>
                  </span>
                  <div className="ns-custom-content-bottom-info">
                    <h4>1. Discovery & Design</h4>
                ...
                <li>
                  ...
                  <div className="ns-custom-content-bottom-info">
                    <h4>2. Agile Development & Testing</h4>
                ...
                <li>
                  ...
                  <div className="ns-custom-content-bottom-info">
                    <h4>3. Launch & Continuous Growth</h4>
          ...
          <div className="ns-custom-img" aria-label="Illustration representing collaborative IT development process">
