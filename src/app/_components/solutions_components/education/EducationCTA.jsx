            ...
            <div className="p-5 text-center shadow-lg position-relative overflow-hidden" 
              ...
              <div style={{ position: "relative", zIndex: 2 }}>
                ...
                <p className="text-white-50 mb-4" style={{ fontSize: "1.05rem", lineHeight: "1.7", maxWidth: "800px", margin: "0 auto" }}>
                  Empower your school, college, university, or training organization with a customized Education Management System built to improve efficiency, enhance learning experiences, and support sustainable growth.
                </p>

                <div className="d-flex flex-wrap justify-content-center gap-3 mb-5 mt-4">
                  {["Education Tech Experts", "Custom Solutions", "Cloud-Based", "Secure Data", "Ongoing Support"].map((item, idx) => (
