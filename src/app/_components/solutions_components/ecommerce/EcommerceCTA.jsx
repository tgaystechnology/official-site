            ...
            <div className="p-5 text-center shadow-lg position-relative overflow-hidden" 
              ...
              <div style={{ position: "relative", zIndex: 2 }}>
                ...
                <h2 className="text-white mb-4" style={{ fontSize: "2.3rem", fontWeight: "800", letterSpacing: "-0.5px" }}>
                  Ready to Launch a High-Converting Ecommerce Platform?
                </h2>
                <p className="text-white-50 mb-4" style={{ fontSize: "1.05rem", lineHeight: "1.7", maxWidth: "800px", margin: "0 auto" }}>
                  Partner with TGAYS Technology Pvt. Ltd. to build a scalable, secure, and revenue-focused E-Commerce System. Whether you need a custom store, B2B portal, or multi-vendor marketplace, our team is ready to help transform your digital commerce vision into reality.
                </p>

                <div className="d-flex flex-wrap justify-content-center gap-3 mb-5 mt-4">
                  {["Custom Ecommerce", "High Conversions", "Scalable Platforms", "Secure Data", "Ongoing Support"].map((item, idx) => (
