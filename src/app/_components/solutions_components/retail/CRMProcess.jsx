...
const CRMProcess = () => {
  const steps = [
    { num: "01", title: "Business Discovery", desc: "We analyze your current processes, business goals, customer journey, and operational challenges.", icon: "search-outline", color: "#00c6ff" },
    { num: "02", title: "Strategy & Planning", desc: "Our consultants define CRM architecture, user roles, automation workflows, and integration requirements.", icon: "git-network-outline", color: "#0072ff" },
    { num: "03", title: "UI/UX Design", desc: "We create intuitive interfaces focused on high productivity and rapid user adoption.", icon: "color-wand-outline", color: "#8e2de2" },
    { num: "04", title: "CRM Development", desc: "Our developers build a secure and scalable CRM platform using modern technologies.", icon: "code-slash-outline", color: "#f107a3" },
    { num: "05", title: "Integration", desc: "We connect your CRM with third-party applications and automate business processes.", icon: "infinite-outline", color: "#ff512f" },
    { num: "06", title: "Testing & QA", desc: "Every module undergoes extensive testing before deployment to ensure reliability.", icon: "shield-checkmark-outline", color: "#f09819" },
    { num: "07", title: "Deployment", desc: "We ensure smooth implementation and comprehensive team onboarding.", icon: "rocket-outline", color: "#56ab2f" },
    { num: "08", title: "Ongoing Support", desc: "Continuous maintenance, optimization, and feature upgrades.", icon: "headset-outline", color: "#00b09b" }
  ];
  ...
  return (
    <>
      ...
      <section className="process-section pt100 pb100 bg-white">
        <div className="container">
          <div className="crumina-module crumina-heading text-center mb-5 pb-4">
            <h2 className="heading-title" style={{ fontSize: "2.5rem", fontWeight: "800", textTransform: "uppercase", color: "#1f2937" }}>
              OUR CRM DEVELOPMENT <span className="c-primary">PROCESS</span>
            </h2>
            <p className="slider-content-text mx-auto" style={{ maxWidth: "800px" }}>
              A proven, step-by-step methodology designed to deliver custom CRM systems that perfectly align with your business goals.
            </p>
          </div>
