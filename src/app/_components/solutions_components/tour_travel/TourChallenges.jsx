...
const TourChallenges = () => {
  const challenges = [
    {
      problem: "Manual Booking Processes",
      problemDesc: "Slow booking workflows create operational inefficiencies and delays.",
      solution: "Automated booking and reservation management systems.",
      icon: "time-outline"
    },
    {
      problem: "Disconnected Operations",
      problemDesc: "Multiple legacy systems lead to severe data silos and fragmented reporting.",
      solution: "Unified travel ERP and CRM integration.",
      icon: "git-network-outline"
    },
    {
      problem: "Poor Customer Experience",
      problemDesc: "Customers expect instant bookings and personalized travel experiences.",
      solution: "Self-service portals, automation, and intelligent CRM workflows.",
      icon: "sad-outline"
    },
    {
      problem: "Revenue Leakage",
      problemDesc: "Tracking commissions, payments, and multi-vendor bookings manually increases errors.",
      solution: "Automated financial management and reporting systems.",
      icon: "trending-down-outline"
    },
    {
      problem: "Limited Scalability",
      problemDesc: "Legacy software restricts business growth and limits integrations.",
      solution: "Cloud-based scalable travel technology platforms.",
      ...
      <div className="container">
        <div className="crumina-module crumina-heading text-center mb-5 pb-4">
          ...
          <p className="slider-content-text mx-auto" style={{ maxWidth: "800px", fontSize: "1.1rem" }}>
            The travel industry moves fast. We build platforms that eliminate operational bottlenecks and prepare you for scalable growth.
          </p>
        </div>
