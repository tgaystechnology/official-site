...
const TourTrust = () => {
  const trustReasons = [
    { title: "Experienced Development Team", desc: "Our experts have extensive experience in travel technology development and digital transformation.", icon: "people-outline" },
    { title: "Agile Delivery Model", desc: "Faster project execution with transparent communication and iterative feedback loops.", icon: "infinite-outline" },
    { title: "Dedicated Project Management", desc: "You receive a single point of contact throughout the entire development lifecycle.", icon: "person-circle-outline" },
    { title: "Enterprise-Level Security", desc: "Advanced security standards, encryption, and strict data compliance practices.", icon: "shield-checkmark-outline" },
    { title: "Long-Term Support", desc: "Post-launch maintenance, monitoring, and continuous feature improvements.", icon: "headset-outline" }
  ];

  const techStack = [
    { category: "Frontend", items: ["React.js", "Angular", "Vue.js", "Next.js"] },
    { category: "Backend", items: ["Node.js", ".NET", "Laravel", "Python"] },
          ...
          <div className="col-lg-6 mb-5 mb-lg-0 pe-lg-5">
            <div className="crumina-module crumina-heading mb-4">
              ...
              <p className="slider-content-text">
                Partner with an experienced travel technology company that understands your operational demands and delivers secure, scalable platforms.
              </p>
            </div>
