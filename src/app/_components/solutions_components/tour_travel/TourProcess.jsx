...
const TourProcess = () => {
  const steps = [
    { num: "01", title: "Discovery & Consultation", desc: "Understand business goals, workflows, and challenges.", icon: "search-outline", color: "#00c6ff" },
    { num: "02", title: "Solution Architecture", desc: "Design the optimal technology framework tailored to your agency.", icon: "layers-outline", color: "#0072ff" },
    { num: "03", title: "UI/UX Design", desc: "Create intuitive interfaces for both end-users and administrators.", icon: "color-palette-outline", color: "#8e2de2" },
    { num: "04", title: "Development", desc: "Build custom travel software using modern and secure technologies.", icon: "code-slash-outline", color: "#f107a3" },
    { num: "05", title: "Integration", desc: "Connect APIs, suppliers, payment gateways, and third-party tools.", icon: "infinite-outline", color: "#ff512f" },
    { num: "06", title: "Testing", desc: "Perform extensive security, performance, and usability testing.", icon: "shield-checkmark-outline", color: "#f09819" },
    { num: "07", title: "Deployment", desc: "Launch the platform with complete setup and configuration.", icon: "rocket-outline", color: "#56ab2f" },
    { num: "08", title: "Support & Optimization", desc: "Continuous monitoring, updates, and feature enhancements.", icon: "headset-outline", color: "#00b09b" }
  ];
        ...
        <div className="container">
          <div className="crumina-module crumina-heading text-center mb-5 pb-4">
            <h2 className="heading-title" style={{ fontSize: "2.5rem", fontWeight: "800", textTransform: "uppercase", color: "#1f2937" }}>
              Our Travel Software <span className="c-primary">Development Process</span>
            </h2>
            <p className="slider-content-text mx-auto" style={{ maxWidth: "800px" }}>
              A proven, step-by-step methodology designed to deliver custom travel technology systems that perfectly align with your goals.
            </p>
          </div>
