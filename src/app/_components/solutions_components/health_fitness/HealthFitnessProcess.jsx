...
const HealthFitnessProcess = () => {
  const steps = [
    { num: "01", title: "Discovery & Strategy", desc: "Understand business goals, audience, and product vision.", icon: "search-outline", color: "#00c6ff" },
    { num: "02", title: "Product Architecture", desc: "Design a scalable and secure technical solution.", icon: "layers-outline", color: "#0072ff" },
    { num: "03", title: "UX/UI Design", desc: "Create intuitive experiences that encourage user engagement.", icon: "color-palette-outline", color: "#8e2de2" },
    { num: "04", title: "Development", desc: "Build applications using modern frameworks and best practices.", icon: "code-working-outline", color: "#f107a3" },
    { num: "05", title: "Testing & Optimization", desc: "Ensure performance, usability, and security before launch.", icon: "shield-checkmark-outline", color: "#ff512f" },
    { num: "06", title: "Deployment", desc: "Launch the solution across web and mobile platforms.", icon: "rocket-outline", color: "#f09819" },
    { num: "07", title: "Continuous Improvement", desc: "Enhance features based on analytics and user feedback.", icon: "sync-outline", color: "#56ab2f" }
  ];
        ...
        <div className="container">
          <div className="crumina-module crumina-heading text-center mb-5 pb-4">
            ...
            <p className="slider-content-text mx-auto" style={{ maxWidth: "800px" }}>
              A proven, agile methodology designed to deliver high-quality fitness solutions on time and within budget.
            </p>
          </div>
