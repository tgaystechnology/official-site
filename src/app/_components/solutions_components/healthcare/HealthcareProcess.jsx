...
const HealthcareProcess = () => {
  const steps = [
    { num: "01", title: "Discovery & Healthcare Consultation", desc: "We assess your healthcare workflows, operational goals, and technology requirements.", icon: "search-outline", color: "#00c6ff" },
    { num: "02", title: "Solution Architecture", desc: "Design secure and scalable healthcare technology infrastructure.", icon: "layers-outline", color: "#0072ff" },
    { num: "03", title: "UI/UX Design", desc: "Create intuitive experiences for patients, healthcare providers, and administrators.", icon: "color-palette-outline", color: "#8e2de2" },
    { num: "04", title: "Agile Development", desc: "Develop healthcare applications using modern technologies and best practices.", icon: "code-slash-outline", color: "#f107a3" },
    { num: "05", title: "Compliance & Security Testing", desc: "Conduct extensive testing to ensure security, performance, and reliability.", icon: "shield-checkmark-outline", color: "#ff512f" },
    { num: "06", title: "Deployment & Integration", desc: "Launch systems with seamless integration into existing healthcare environments.", icon: "rocket-outline", color: "#f09819" },
    { num: "07", title: "Ongoing Support & Optimization", desc: "Provide maintenance, monitoring, and continuous enhancements.", icon: "headset-outline", color: "#56ab2f" }
  ];
        ...
        <div className="container">
          <div className="crumina-module crumina-heading text-center mb-5 pb-4">
            <h2 className="heading-title">
              Our Healthcare Software <span className="c-primary">Development Process</span>
            </h2>
            <p className="slider-content-text mx-auto" style={{ maxWidth: "800px" }}>
              A proven, step-by-step methodology designed to deliver custom healthcare technology systems that perfectly align with your clinical and operational goals.
            </p>
          </div>
