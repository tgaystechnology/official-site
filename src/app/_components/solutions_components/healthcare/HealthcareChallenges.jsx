  ...
  const challenges = [
    {
      ...
      problemDesc: "Manual workflows increase operational costs and slow patient care.",
      solution: "Automated healthcare management systems that streamline operations.",
      icon: "time-outline"
    },
    {
      problem: "Fragmented Patient Data",
      problemDesc: "Disconnected systems make patient information difficult to access and consolidate.",
      solution: "Centralized healthcare software platforms with integrated data management.",
      icon: "documents-outline"
    },
    {
      problem: "Poor Patient Engagement",
      problemDesc: "Low patient retention and satisfaction due to poor digital communication.",
      solution: "Patient portals, healthcare mobile apps, and automated communication systems.",
      icon: "person-remove-outline"
    },
    {
      problem: "Compliance & Security Risks",
      problemDesc: "Healthcare organizations must fiercely protect highly sensitive patient information.",
      solution: "Secure architectures, encryption, role-based access controls, and compliance.",
      icon: "shield-half-outline"
    },
    {
      problem: "Scalability Limitations",
      problemDesc: "Legacy on-premise systems constantly struggle to support organizational growth.",
      solution: "Cloud-based healthcare platforms specifically designed for infinite scalability.",
      icon: "server-outline"
    }
  ];
      ...
      <div className="container">
        <div className="crumina-module crumina-heading text-center mb-5 pb-4">
          ...
          <p className="slider-content-text mx-auto" style={{ maxWidth: "800px", fontSize: "1.1rem" }}>
            The healthcare industry demands precision and security. We build platforms that eliminate operational bottlenecks and ensure compliance.
          </p>
        </div>
