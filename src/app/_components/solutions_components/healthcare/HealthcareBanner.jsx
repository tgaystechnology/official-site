  ...
  return (
    <>
      ...
      <section
        ...
        role="banner"
        aria-label="healthcare software development company India"
        title="healthcare software development company India"
        aria-labelledby="healthcare-heading"
        style={{ backgroundImage: "url('/img/healthcare-software-development-company-india.png')", height: "100vh", minHeight: "650px", display: "flex", alignItems: "center", padding: "0", margin: "0", overflow: "hidden", position: "relative" }}
      >
        ...
        <div className="container position-relative" style={{ zIndex: 2 }}>
          <div className="banner-text" style={{ padding: "0" }}>
            ...
            <p style={{ fontSize: "1.1rem", lineHeight: "1.6", marginBottom: "30px", color: "#eee", maxWidth: "800px" }}>
              Accelerate digital transformation through secure, scalable, and intelligent healthcare technology solutions.
            </p>
