...
const M365Challenges = () => {
  const challenges = [
    { challenge: "Inefficient Business Processes", solution: "Workflow automation using Power Automate and custom applications." },
    { challenge: "Data Silos", solution: "Centralized Microsoft 365 ecosystem with integrated reporting." },
    { challenge: "Low Employee Productivity", solution: "Collaboration-focused Microsoft Teams and SharePoint solutions." },
    { challenge: "Legacy Systems", solution: "Secure migration and modernization strategies." },
    { challenge: "Lack of Business Visibility", solution: "Power BI dashboards and business intelligence reporting." },
    { challenge: "High Operational Costs", solution: "Automated workflows and low-code application development." }
  ];
    ...
    <section className="challenges-solutions-section pt100 pb70 bg-white">
      ...
      <div className="container">
        <div className="crumina-module crumina-heading text-center mb-5">
          ...
          <p className="slider-content-text">Common Enterprise M365 Obstacles and Our Tailored Solutions</p>
        </div>
