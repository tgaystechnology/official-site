...
const AppSupportServices = () => {
  ...
  const services = [
    {
      id: "monitoring",
      tabTitle: "Monitoring & Incident Mgmt",
      title: "Monitoring & Incident Management",
      intro: "We continuously monitor application performance, infrastructure health, database operations, APIs, and user activity to identify issues in real-time before they affect your business.",
    ...
    {
      id: "corrective",
      tabTitle: "Corrective Maintenance",
      title: "Corrective Maintenance Services",
      intro: "Our team quickly resolves software defects, bugs, functionality issues, and unexpected application failures to restore normal operations.",
      listTitle: "Support Focus Areas",
      listItems: [
        "Bug fixing & patching",
    ...
    },
    {
      ...
      title: "Preventive Application Maintenance",
      intro: "Preventive maintenance minimizes future disruptions through regular audits, performance reviews, and proactive system optimizations.",
      listTitle: "Proactive Measures",
      listItems: [
        "Code base reviews",
    ...
    {
      id: "adaptive",
      tabTitle: "Adaptive Maintenance",
      title: "Adaptive Maintenance Solutions",
      intro: "Applications must evolve with changing business requirements, operating systems, hardware platforms, and technology environments.",
      listTitle: "Adaptation Services",
      listItems: [
    ...
    {
      id: "perfective",
      tabTitle: "Perfective Maintenance",
      title: "Perfective App Maintenance",
      intro: "We enhance applications based on user feedback and business growth requirements, adding new features without rebuilding from scratch.",
      listTitle: "Enhancement Activities",
      listItems: [
        "UI/UX improvements",
    ...
    {
      id: "saas",
      tabTitle: "SaaS & Enterprise Support",
      title: "SaaS & Enterprise Support Services",
      intro: "Our dedicated teams specialize in supporting complex enterprise systems (ERP, CRM, HRMS) and multi-tenant SaaS applications to ensure seamless availability.",
      listTitle: "Enterprise Capabilities",
      listItems: [
      ...
      <div className="container">
        <div className="crumina-module crumina-heading text-center mb-5">
          <h2 className="heading-title" style={{ fontSize: "2.25rem", fontWeight: "700" }}>
            OUR <span className="c-primary">APP SUPPORT</span> SERVICES
          </h2>
          <p className="slider-content-text">Comprehensive maintenance strategies designed to keep your business-critical applications secure, optimized, and scalable.</p>
        </div>
