        ...
        <div className="container" style={{ position: "relative", zIndex: 2 }}>
          <div className="banner-text" style={{ padding: "0" }}>
            ...
            <p style={{ fontSize: "1.1rem", lineHeight: "1.6", marginBottom: "30px", color: "#eee", maxWidth: "800px" }}>
              Businesses today rely heavily on software applications to manage operations, serve customers, and drive revenue. TGAYS Technology Pvt. Ltd. provides comprehensive Application Support & Maintenance Services designed to ensure your business-critical applications remain secure, optimized, scalable, and available around the clock.
            </p>
            <div className="d-flex flex-wrap gap-3 mt-4" style={{ gap: "12px" }}>
              ...
              <Link href="/contact-us" className="first-tag" aria-label="Hire Dedicated Support" style={{ margin: "0", background: "transparent", border: "2px solid #fff", color: "#fff" }}>
                Hire Dedicated Support
              </Link>
            </div>
          </div>
        </div>
          ...
          <div className="row align-items-center">
            <div className="col-lg-6 mb-4 mb-lg-0">
              <div className="crumina-module crumina-heading">
                <h2 style={{ fontSize: "2rem", fontWeight: "700", lineHeight: "1.3", marginBottom: "20px" }}>
                  Maximize Business Productivity and Minimize Downtime
                </h2>
                <p style={{ fontSize: "1.05rem", lineHeight: "1.6", color: "#555", marginBottom: "15px" }}>
                  Whether you operate a SaaS platform, enterprise application, CRM, ERP system, eCommerce store, healthcare portal, or custom business software, our expert team delivers proactive monitoring, issue resolution, performance optimization, and continuous improvement services.
                </p>
                <p style={{ fontSize: "1.05rem", lineHeight: "1.6", color: "#555", marginBottom: "25px" }}>
                  Our application support and maintenance services help businesses reduce operational risks, improve user experience, enhance system reliability, and achieve long-term digital success.
                </p>
                 ...
                 <div className="get-started-box p-4 rounded-4" style={{ background: "rgba(0, 131, 255, 0.05)", borderLeft: "4px solid #0083FF", borderRadius: "12px" }}>
                  <h4 style={{ fontSize: "1.1rem", fontWeight: "700", marginBottom: "10px", color: "#0c1527" }}>Get Expert Support Today</h4>
            ...
            <div className="col-lg-6">
              <div className="p-4 rounded-4 shadow-sm" style={{ background: "#fafafa", border: "1px solid #eee", borderRadius: "16px" }}>
                <h3 className="mb-4 text-dark" style={{ fontSize: "1.25rem", fontWeight: "700" }}>Our Application Support Capabilities</h3>
                <div className="row">
