...
const ProductChallenges = () => {
  const challenges = [
    { challenge: "Slow Product Launches", solution: "Agile product development methodology that accelerates releases." },
    { challenge: "High Development Costs", solution: "MVP-first approach that minimizes unnecessary investment." },
    { challenge: "Lack of Product-Market Fit", solution: "Discovery workshops and validation frameworks." },
    { challenge: "Scalability Issues", solution: "Cloud-native architecture designed for future growth." },
    { challenge: "Limited Technical Expertise", solution: "Dedicated product development teams and strategic consulting." }
  ];
    ...
    <section className="challenges-solutions-section pt100 pb70 bg-white">
      ...
      <div className="container">
        <div className="crumina-module crumina-heading text-center mb-5">
          ...
          <p className="slider-content-text">Common Product Roadblocks and Our Strategic Solutions</p>
        </div>
