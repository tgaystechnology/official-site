...
const OffshoreChallenges = () => {
  const challenges = [
    { challenge: "Difficulty Hiring Skilled Developers", solution: "Access a large pool of pre-vetted offshore developers with specialized expertise." },
    { challenge: "Rising Development Costs", solution: "Reduce development costs while maintaining high quality and productivity." },
    { challenge: "Delayed Product Launches", solution: "Dedicated offshore teams accelerate product development and reduce time-to-market." },
    { challenge: "Scaling Challenges", solution: "Rapid team expansion without lengthy hiring processes." },
    { challenge: "Technology Skill Gaps", solution: "Access experts in AI, cloud, mobile, SaaS, fintech, healthcare, and enterprise solutions." }
  ];
    ...
    <section className="challenges-solutions-section pt100 pb70 bg-white">
      ...
      <div className="container">
        <div className="crumina-module crumina-heading text-center mb-5">
          ...
          <p className="slider-content-text">Common Scaling Roadblocks and Our Strategic Resolutions</p>
        </div>
...
export default OffshoreChallenges;
