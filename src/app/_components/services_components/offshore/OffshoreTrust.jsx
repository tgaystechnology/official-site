...
const OffshoreTrust = () => {
  const trustFactors = [
    {
      title: "Experienced Offshore Developers",
      desc: "Our developers bring years of practical experience across diverse industries. We run rigorous screening processes to ensure top-tier talent matches your guidelines."
    },
    {
      title: "Enterprise Security Standards",
      desc: "We enforce strict security procedures including NDA protection, secure clean-code practices, role-based cloud access controls, and full data encryption."
    },
    {
      title: "Transparent Sprint Deliveries",
      desc: "Maintain absolute project control with dedicated account managers, weekly sprint reviews, live staging environments, and direct developer communication channels."
    },
    {
      title: "Modern Tech Stack Specialization",
      desc: "Leverage React, Angular, Node.js, Python, Java, Flutter, React Native, AWS, and Azure. We stay current with artificial intelligence models and REST API connectors."
    }
  ];
