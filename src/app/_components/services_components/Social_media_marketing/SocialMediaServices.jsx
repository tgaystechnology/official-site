  ...
  const services = [
    {
      ...
      intro: "Every successful campaign begins with a strong strategy. We craft tailored roadmaps to achieve your business goals.",
      listTitle: "Strategy Services Include",
      listItems: [
    ...
    },
    {
      ...
      intro: "As a trusted social media management company in India, we seamlessly manage your brand presence across multiple platforms.",
      listTitle: "Management Services Include",
      listItems: [
        "Content Scheduling",
      ...
      outcomeTitle: "Platforms We Manage",
      outcomeItems: [
        "Facebook & Instagram",
        "LinkedIn (B2B Focus)",
        "X (Twitter) & Pinterest",
    ...
    },
    {
      ...
      intro: "Our team creates high-performing paid campaigns that cut through the noise and generate qualified leads and sales.",
      listTitle: "Advertising Solutions",
      listItems: [
      ...
      outcomeTitle: "Campaign Benefits",
      outcomeItems: [
    ...
    },
    {
      ...
      intro: "Great content drives engagement and brand loyalty. We produce thumb-stopping creatives tailored for each platform.",
      listTitle: "Content Types",
      listItems: [
        "Social Media Posts & Graphics",
        "Instagram Reels & Shorts",
        "Stories & Interactive Polls",
        "Educational Carousels",
        "Infographics & Motion Graphics"
      ],
      outcomeTitle: "Creative Outcomes",
      outcomeItems: [
    ...
    },
    {
      ...
      intro: "Collaborate with industry-relevant influencers and micro-influencers to expand your reach and credibility.",
    ...
    {
      id: "lead-generation",
      tabTitle: "Lead Generation",
      title: "Social Media Lead Generation",
      intro: "Turn social media traffic into qualified leads through optimized funnels and high-converting campaigns.",
      listTitle: "Lead Gen Services",
      listItems: [
      ...
      <div className="container">
        <div className="crumina-module crumina-heading text-center mb-5">
          <h2 className="heading-title" style={{ fontSize: "2.25rem", fontWeight: "700" }}>
            SOCIAL MEDIA MARKETING <span className="c-primary">SERVICES WE OFFER</span>
          </h2>
          <p className="slider-content-text">From organic growth to paid advertising, we offer comprehensive solutions to elevate your brand.</p>
        </div>
