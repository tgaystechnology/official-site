          ...
          <div className="row align-items-center position-relative" style={{ zIndex: 2 }}>
            ...
            <div className="col-lg-7 text-center text-lg-start mb-5 mb-lg-0 pe-lg-5">
              <h2 style={{ fontSize: "2.4rem", fontWeight: "800", color: "#ffffff", marginBottom: "20px", lineHeight: "1.2" }}>
                Ready to Grow Your Brand Through Social Media?
              </h2>
              <p style={{ fontSize: "1.1rem", color: "rgba(255,255,255,0.8)", marginBottom: "30px", lineHeight: "1.6" }}>
                Your customers spend hours every day on social media. The question is whether they are engaging with your business or your competitors. Partner with TGAYS Technology and transform social media into a powerful channel for brand awareness, customer engagement, lead generation, and revenue growth.
              </p>
